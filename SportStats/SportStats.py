...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def build_graph(self):
        ...
        p0.setTitle(f'Игры {self.team1} с {date_list[0]} по {date_list[-1]}', **{'color': '#000', 'size': '14pt'})
        p0.addLegend()
        p0.showGrid(y=True)
        ...
        for i in range(len(give)):
            if titles[i].find("Победа") > 0:
                ...
                fill = (234,230,202,90)
            text = pg.TextItem(text=f'{titles[i]}', anchor=(0.5, -0.2), angle=0, border='b', fill=fill)
            text.setColor((0,0,0))
        ...
        if self.team2 == "Не выбрано":
            ...
            p0_2.setTitle(f'Игры {self.team2} с {date_list[0]} по {date_list[-1]}', **{'color': '#000', 'size': '14pt'})
            p0_2.addLegend()
        ...
        try:
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    p1_2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
        ...
        try:
            ...
            if len(y) != 0:
                ...
                p2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
                p2.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    p2_2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
        ...
        try:
            ...
            if len(y) != 0:
                ...
                p3.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
                p3.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    p3_2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
        ...
        try:
            ...
            if len(y) != 0:
                ...
                p4.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
                p4.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    p4_2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
        ...
        try:
            ...
            if len(y) != 0:
                ...
                p5.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
                p5.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    p5_2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
        ...
        try:
            ...
            if len(y) != 0:
                ...
                p6.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
                p6.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    p6_2.setTitle(stat_name, **{'color': '#000', 'size': '14pt'})
        ...
        if self.stat_check4.isChecked() and self.stat_check4.text() == "Голы по периодам":
            ...
            if len(y) != 0:
                ...
                pp1.setTitle("Голы в 1 период", **{'color': '#000', 'size': '14pt'})
                pp1.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    pp1_2.setTitle("Голы в 1 период", **{'color': '#000', 'size': '14pt'})
            ...
            if len(y) != 0:
                ...
                pp2.setTitle("Голы во 2 период", **{'color': '#000', 'size': '14pt'})
                pp2.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    pp2_2.setTitle("Голы во 2 период", **{'color': '#000', 'size': '14pt'})
            ...
            if len(y) != 0:
                ...
                pp3.setTitle("Голы в 3 период", **{'color': '#000', 'size': '14pt'})
                pp3.showGrid(y=True)
            ...
            if self.team2 != "Не выбрано":
                ...
                if len(y) != 0:
                    ...
                    pp3_2.setTitle("Голы в 3 период", **{'color': '#000', 'size': '14pt'})
        ...
        async with session.get(url=url) as response:  # тут обрабатываем запрос на страничку html либо json
            ...
            if response.status == 200:
                ...
                if self.sport == 'Футбол':  # парсим json
                    ...
                    team_home = stat_soup.find(class_="sp-MatchCenterBoard-left")
                    team_guest = stat_soup.find(class_="sp-MatchCenterBoard-right")
                    team_home_name = team_home.find(class_="sp-MatchCenterBoard-team-name").text.strip()
                    team_guest_name = team_guest.find(class_="sp-MatchCenterBoard-team-name").text.strip()
