...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def addFunctions(self):
        ...
        # сделать всплывающее окно с проверкой на одинаковые team1 и team2
    ...
    def get_base_stat(self, data, date_list, team_key):
        # вернем забито(+) пропущено(-)
        # еще вернем надписи (соперник, дата, статус+исход)
        # еще вернем кэфы, если кэфа нет добавляем 0
        titles = []
        give = []  # забито
        get = []  # пропущено
        odds_win = []
    ...
    def build_graph(self):
        ...
        try:
            ...
            if len(y) != 0:
                ...
                p1.setTitle(stat_name, **{'color': '#FFF', 'size': '14pt'})
                p1.showGrid(y=True)
